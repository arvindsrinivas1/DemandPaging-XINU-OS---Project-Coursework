...
*/
	...
	/* maxaddr should point to the last byte of the memory below Backing store. We have been given
 	a BS of 8 MB and the rest for 8MB. Hence maxaddr should point to the last byte of 2047th page (0-2047) = 2048 pages
	Hence changing this to 2048 from 1536(this was pointing to 6MB*/
